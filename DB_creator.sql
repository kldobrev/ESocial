...
ALTER TABLE fan_page ADD FOREIGN KEY(creator) REFERENCES user_profile(user_id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE page_like ADD FOREIGN KEY(page_id) REFERENCES fan_page(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE page_post ADD FOREIGN KEY(post_id) REFERENCES post(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE page_post ADD FOREIGN KEY(page_id) REFERENCES fan_page(id) ON UPDATE CASCADE ON DELETE CASCADE;