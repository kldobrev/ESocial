# This Makefile is for the ESocial extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     DISTNAME => q[ESocial]
#     EXE_FILES => [q[script/esocial_cgi.pl], q[script/esocial_create.pl], q[script/esocial_fastcgi.pl], q[script/esocial_server.pl], q[script/esocial_test.pl]]
#     LICENSE => q[perl]
#     NAME => q[ESocial]
#     NO_META => q[1]
...
MAN3EXT = 3pm
INSTALLDIRS = site
INSTALL_BASE = /home/kldobrev/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
MAKEMAKER   = /home/kldobrev/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.64
MM_REVISION = 66400
...
O_FILES  = 
H_FILES  = 
MAN1PODS = script/esocial_cgi.pl \
	script/esocial_create.pl \
	script/esocial_fastcgi.pl \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=1 --perm_rw=$(PERM_RW) \
	  ...
	  script/esocial_server.pl $(INST_MAN1DIR)/esocial_server.pl.$(MAN1EXT) \
...
EXE_FILES = script/esocial_cgi.pl script/esocial_create.pl script/esocial_fastcgi.pl script/esocial_server.pl script/esocial_test.pl

pure_all :: $(INST_SCRIPT)/esocial_test.pl $(INST_SCRIPT)/esocial_fastcgi.pl $(INST_SCRIPT)/esocial_server.pl $(INST_SCRIPT)/esocial_create.pl $(INST_SCRIPT)/esocial_cgi.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/esocial_test.pl $(INST_SCRIPT)/esocial_fastcgi.pl \
	  $(INST_SCRIPT)/esocial_server.pl $(INST_SCRIPT)/esocial_create.pl \
	  $(INST_SCRIPT)/esocial_cgi.pl 

$(INST_SCRIPT)/esocial_test.pl : script/esocial_test.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/esocial_test.pl
	$(CP) script/esocial_test.pl $(INST_SCRIPT)/esocial_test.pl
	$(FIXIN) $(INST_SCRIPT)/esocial_test.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/esocial_test.pl

$(INST_SCRIPT)/esocial_fastcgi.pl : script/esocial_fastcgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/esocial_fastcgi.pl
	$(CP) script/esocial_fastcgi.pl $(INST_SCRIPT)/esocial_fastcgi.pl
	$(FIXIN) $(INST_SCRIPT)/esocial_fastcgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/esocial_fastcgi.pl

$(INST_SCRIPT)/esocial_server.pl : script/esocial_server.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/esocial_server.pl
	$(CP) script/esocial_server.pl $(INST_SCRIPT)/esocial_server.pl
	$(FIXIN) $(INST_SCRIPT)/esocial_server.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/esocial_server.pl

$(INST_SCRIPT)/esocial_create.pl : script/esocial_create.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/esocial_create.pl
	$(CP) script/esocial_create.pl $(INST_SCRIPT)/esocial_create.pl
	$(FIXIN) $(INST_SCRIPT)/esocial_create.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/esocial_create.pl

$(INST_SCRIPT)/esocial_cgi.pl : script/esocial_cgi.pl $(FIRST_MAKEFILE) $(INST_SCRIPT)$(DFSEP).exists $(INST_BIN)$(DFSEP).exists
	$(NOECHO) $(RM_F) $(INST_SCRIPT)/esocial_cgi.pl
	$(CP) script/esocial_cgi.pl $(INST_SCRIPT)/esocial_cgi.pl
	$(FIXIN) $(INST_SCRIPT)/esocial_cgi.pl
	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_SCRIPT)/esocial_cgi.pl
...
catalyst_par :: all
	$(NOECHO) $(PERL) -Ilib -Minc::Module::Install -MModule::Install::Catalyst -e"Catalyst::Module::Install::_catalyst_par( '', 'ESocial', { CLASSES => [], PAROPTS =>  {}, ENGINE => 'CGI', SCRIPT => '', USAGE => q## } )"
